...
let handler = async(m, { conn }) => {
    let kontol = `Kebijakan Privasi, Syarat Ketentuan dan Peraturan BOTYNYAKAMU
...
Syarat Ketentuan BOTYNYAKAMU
1. Bot akan keluar dari group apabila sudah waktunya keluar.
2. BOTYNYAKAMU dapat mem-ban users secara sepihak terlepas dari users salah atau tidak.
